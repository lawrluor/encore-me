      ...
      <main>
        ...
        <section className="p-10">
          <form>
            ...
            <input id="name" name="name" type="text" className="block h-44" />

            <label htmlFor="email" className="opacity-80">Email</label>
            <input id="email" name="email" type="email" className="block h-44" />

            <label htmlFor="password" className="opacity-80">Password</label>
            <input id="password" name="password" type="password" className="block h-44" />

            <label htmlFor="passwordRepeat" className="opacity-80">Confirm Password</label>
            <input id="passwordRepeat" name="passwordRepeat" type="password" className="block h-44" />
