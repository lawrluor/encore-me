    ...
    <div className="w-dvw h-dvh">
      ...
      <main>
        <section className="relative w-full aspect-40/16 ">
          ...
          <Image loading="eager" src="/images/busking_ensemble_1600w.webp" alt="Trumpeter and pianist giving an engaging street performance" width="1200" height="600" sizes="(max-width: 640px) 0vw, 80vw" className="absolute right-0 top-0 w-4/5 hidden min-sm:block" />
        ...
        <section className="py-40 px-40 flex flex-wrap gap-40 min-md:py-80">
          ...
          <div>
            <div className="border-l-10 border-foreground-muted rounded-l-md p-20">
        ...
        <section className="pb-80 px-40 flex gap-40 flex-wrap">
