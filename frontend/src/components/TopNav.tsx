...
export const TopNav = () => {
  return (
    <nav className="h-80 p-20 flex justify-between w-full" aria-label="Primary">
      <Link className="hover:opacity-60" href={{ pathname: '/Home' }}><p className="text-2xl">ENCORE ME</p></Link>

      <span>
        <button onClick={logoutUserAction} className="h-44 p-5 cursor-pointer hover:opacity-60" aria-label="Log Out">
